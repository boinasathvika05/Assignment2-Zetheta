...
def get_vector_store():
    ...
    if _chroma_client is None:
        try:
            is_serverless = bool(os.getenv("VERCEL") or os.getenv("VERCEL_ENV") or os.getenv("VERCEL_REGION") or os.getenv("NOW_REGION") or os.getenv("AWS_LAMBDA_FUNCTION_NAME") or not os.access(".", os.W_OK))
            persist_dir = "/tmp/chroma_data" if is_serverless else settings.CHROMA_PERSIST_DIRECTORY
